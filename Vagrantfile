# Configures Ubuntu 14.04 VM to be used with FlashChain 2.0 (Graphene)
...
if [ ! -d "graphene" ]; then
  echo_msg "building flashchain graphene toolkit.."
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    aws.security_groups = [ 'flashchainxt' ]
    override.vm.hostname = 'flashchainxt-aws'
