...
[wiki](https://github.com/fengqunltd/flc_core/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/fengqunltd/flc_core.git
    cd flc_core
...
[here](https://github.com/fengqunltd/flc_core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).

Support
-------
Technical support is available in the [BitSharesTalk technical support subforum](https://flashchain.org/index.php?board=45.0).
...
about API's for the [witness node](https://flashchain.github.io/doxygen/namespacegraphene_1_1app.html) and the
[wallet](https://flashchain.github.io/doxygen/classgraphene_1_1wallet_1_1wallet__api.html).
If you want information which is not available from an API, it might be available
from the [database](https://flashchain.github.io/doxygen/classgraphene_1_1chain_1_1database.html);
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/fengqunltd/flashchain/blob/fengqunltd/libraries/chain/include/graphene/chain/protocol/types.hpp).
